    ...
    <section id="location" className="w-full bg-[#faf3e0] pt-[50px] pb-[50px]">
      <div className="w-full max-w-[1200px] mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          {/* Column 1: Location */}
          <div>
            <h3 className="text-center font-bold uppercase">Location</h3>
          ...
          <div className="w-full flex flex-col items-center">
            <div className="w-full max-w-[400px]">
              <h3 className="uppercase font-bold text-center md:text-right mt-4 md:mt-0">
                Hours
              </h3>
              {[
                ...
                <p
                  key={day}
                  className={`uppercase text-center md:text-right text-md py-2 ${
