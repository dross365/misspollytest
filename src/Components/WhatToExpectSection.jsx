...
import teaTray from '../assets/tea_tray.jpg'
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 w-full md:w-[80%] lg:w-full mx-auto pb-[100px]'>
        ...
        <div className='order-1 md:order-2 p-6'>
          ...
          <p className='text-sm md:text-md lg:text-lg p-4 mt-2 text-justify'>
            ...
            been served your host will present the table with your tiered tray.
            The tiered tray will contain 4-5 savory items per person, 2 scones
            per person and 3-4 sweet items per person. The table will be
